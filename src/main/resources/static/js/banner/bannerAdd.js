layui.use(['form','layer','layedit','laydate','upload'],function(){
    ...
    form.on("submit(addNews)",function(data){
        ...
        var urlPath = "/admin/noticeAdd";
        if ($("#taskId").val()!==""){
            urlPath = "/admin/noticeUpdate";
        }
        // 实际使用时的提交信息
        $.ajax({
            type:"POST",
            ...
            data:JSON.stringify({
                id: $("#taskId").val(),
                noticetitle: $(".newsName").val(),  //任务标题
                noticecontent: layedit.getContent(editIndex).split('<audio controls="controls" style="display: none;"></audio>')[0],  //任务内容
                noticeimg : $(".thumbImg").attr("src"),  //缩略图
